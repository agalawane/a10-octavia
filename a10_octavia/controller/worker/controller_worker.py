...
class A10ControllerWorker(base_taskflow.BaseTaskFlowEngine):
    ...
    def create_listener(self, listener_id):
        ...
        if CONF.a10_global.enable_hierarchical_multitenancy and CONF.a10_global.use_parent_partition:
            parent_project_id = utils.get_parent_project(listener.project_id)

        if listener.project_id in CONF.hardware_thunder.devices or parent_project_id in CONF.hardware_thunder.devices:
    ...
    def create_load_balancer(self, load_balancer_id):
        ...
        parent_project_id = None
        if CONF.a10_global.enable_hierarchical_multitenancy and CONF.a10_global.use_parent_partition:
            parent_project_id = utils.get_parent_project(lb.project_id)

        if lb.project_id in CONF.hardware_thunder.devices or parent_project_id in CONF.hardware_thunder.devices:
    ...
    def create_member(self, member_id):
        ...
        parent_project_id = None
        if CONF.a10_global.enable_hierarchical_multitenancy and CONF.a10_global.use_parent_partition:
            parent_project_id = utils.get_parent_project(member.project_id)

        if member.project_id in CONF.hardware_thunder.devices or parent_project_id in CONF.hardware_thunder.devices:
