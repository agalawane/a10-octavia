    ...
    def get_new_lb_networking_subflow(self, topology):
        ...
        if topology == constants.TOPOLOGY_ACTIVE_STANDBY:
            ...
            new_LB_net_subflow.add(vthunder_tasks.AmphoraePostVIPPlug(
                ...
                rebind={a10constants.VTHUNDER: a10constants.BACKUP_VTHUNDER}))
            '''new_LB_net_subflow.add(vthunder_tasks.AmphoraePostVIPPlug(
                name=a10constants.AMPHORAE_POST_VIP_PLUG + "neha",
                requires=(constants.LOADBALANCER, a10constants.VTHUNDER)))'''
            new_LB_net_subflow.add(
                vthunder_tasks.VThunderComputeConnectivityWait(
                    name=a10constants.BACKUP_CONNECTIVITY_WAIT + "test",
                    requires=(a10constants.VTHUNDER, constants.AMPHORA)))
            new_LB_net_subflow.add(
                vthunder_tasks.VThunderComputeConnectivityWait(
                    name=a10constants.BACKUP_CONNECTIVITY_WAIT,
            ...
            new_LB_net_subflow.add(vthunder_tasks.GetVThunderInterface(
                name=a10constants.BACKUP_ENABLE_INTERFACE+"a",
                requires=a10constants.VTHUNDER,
                provides=(a10constants.VTHUNDER, a10constants.IFNUM_MASTER, a10constants.IFNUM_BACKUP)))
            new_LB_net_subflow.add(vthunder_tasks.EnableInterfaceForActiveStandbyVThunder(
                name=a10constants.BACKUP_ENABLE_INTERFACE+"c",
                requires=(a10constants.VTHUNDER, a10constants.IFNUM_BACKUP, a10constants.IFNUM_MASTER)))
            new_LB_net_subflow.add(vthunder_tasks.GetVThunderInterface(
                name=a10constants.BACKUP_ENABLE_INTERFACE+"n",
                rebind={a10constants.VTHUNDER: a10constants.BACKUP_VTHUNDER},
                provides=(a10constants.VTHUNDER, a10constants.IFNUM_MASTER, a10constants.IFNUM_BACKUP)))
            new_LB_net_subflow.add(vthunder_tasks.EnableInterfaceForActiveStandbyVThunder(
                name=a10constants.BACKUP_ENABLE_INTERFACE+"d",
                requires=(a10constants.VTHUNDER, a10constants.IFNUM_BACKUP, a10constants.IFNUM_MASTER)))
            new_LB_net_subflow.add(a10_database_tasks.MarkVThunderStatusInDB(
                name=a10constants.MARK_VTHUNDER_BACKUP_ACTIVE_IN_DB,
                rebind={a10constants.VTHUNDER: a10constants.BACKUP_VTHUNDER},
